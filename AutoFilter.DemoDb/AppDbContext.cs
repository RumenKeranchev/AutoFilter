        ...
        void Seed()
        {
            var invoices = new List<Invoice>
            {
                new() {
                    ...
                    Type = "Invoice",
                    Status = "Sent",
                    SentDate = new DateTime(2025, 10, 2, 15, 0, 0, DateTimeKind.Local),
                    DueDate = DateTime.UtcNow.Date.AddDays(30).AddHours(15),
                    IsPaid = true,
                    Total = 24,
                },
                new()
                ...
                new()
                {
                    ...
                    Type = "Credit Note",
                    Status = "Sent",
                    SentDate = new DateTime(2025, 09, 22, 11, 0, 0, DateTimeKind.Local),
                    DueDate = DateTime.UtcNow.Date.AddDays(20).AddHours(11),
                    IsPaid = true,
                    Total = -6,
                },
                new()
